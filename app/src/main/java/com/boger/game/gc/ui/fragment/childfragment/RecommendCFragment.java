...
import com.boger.game.gc.base.RecyclerViewData;
import com.boger.game.gc.model.BannerModel;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            switch (getItemViewType(position)) {
                ...
                case TYPE_NORMAL:
                    ...
                    ImageLoaderUtils.load(itemList.get(0).getImageSrc(), normalVh.image_1);
                    ImageLoaderUtils.load(itemList.get(1).getImageSrc(), normalVh.image_2);
                    ImageLoaderUtils.load(itemList.get(2).getImageSrc(), normalVh.image_3);
                    ImageLoaderUtils.load(itemList.get(3).getImageSrc(), normalVh.image_4);
            ...
            private class HotItemRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
                ...
                public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                    ...
                    if (position < hotList.size()) {
                        ...
                        ImageLoaderUtils.load(model.getImageSrc(), vh.imageView);
